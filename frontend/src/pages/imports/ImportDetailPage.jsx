  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4 no-print">
        ...
        <PageHeader 
          title={`Chi tiết phiếu nhập: ${receipt.receipt_code}`} 
          action={actionButton}
        />
      </div>
      ...
      <div className="print-container space-y-6 p-0 print:p-6">
        ...
        <div className="hidden print:block text-center border-b border-slate-200 pb-4 mb-6">
          <h1 className="text-2xl font-bold uppercase text-slate-900">PHIẾU NHẬP KHO</h1>
          <p className="text-sm text-slate-500 mt-1">Mã phiếu: {receipt.receipt_code}</p>
          <p className="text-xs text-slate-400 mt-0.5">Ngày tạo: {receipt.import_date}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="no-print rounded-2xl border border-slate-200 bg-cyan-50 p-6 shadow-sm flex flex-col justify-center">
        ...
        <div className="hidden print:flex items-center justify-between border border-slate-200 rounded-xl p-5 mt-2">
          ...
          <div className="text-right">
            <p className="text-slate-500 text-sm">Tổng giá trị phiếu nhập</p>
        ...
        <div className="hidden print:grid grid-cols-2 gap-4 text-center mt-12 pt-8 border-t border-slate-200">
          <div>
            <p className="font-bold">Người tạo phiếu</p>
